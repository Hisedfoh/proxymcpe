...
var proxy = Proxy{hitbox: 0.6, fly: true, antikb: false, jumpboost: false, speed: false, killaura: false, haste: false, slowfalling: false, noclip: false, nightvision: false}
var application App
